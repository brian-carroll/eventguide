...
var _user$project$Secrets$youtube = 'AIzaSyBt1XQYVRERYoq_Z1NmjQTrIdNGRcdRTBY';
var _user$project$Secrets$ticketmaster = 'etFF1qfD0poYWLeXnM3wBC3vf5F9sur7';

var _user$project$Api_TicketMaster$selectImageUrl = F3(
	function (ratio, height, imageList) {
		var targetRatio = _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Tuple$first(ratio)) / _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Tuple$second(ratio));
		var width = _elm_lang$core$Basics$ceiling(
			_elm_lang$core$Basics$toFloat(height) * targetRatio);
		var selectBetterOfTwoImages = F2(
			function (nextImage, bestImage) {
				var nextCoversTarget = (_elm_lang$core$Native_Utils.cmp(nextImage.width, width) > -1) && (_elm_lang$core$Native_Utils.cmp(nextImage.height, height) > -1);
				var bestCoversTarget = (_elm_lang$core$Native_Utils.cmp(bestImage.width, width) > -1) && (_elm_lang$core$Native_Utils.cmp(bestImage.height, height) > -1);
				var ratioDiff = function (img) {
					return _elm_lang$core$Basics$abs(
						(_elm_lang$core$Basics$toFloat(
							_elm_lang$core$Tuple$first(img.ratio)) / _elm_lang$core$Basics$toFloat(
							_elm_lang$core$Tuple$second(img.ratio))) - targetRatio);
				};
				var ratioDiffComparison = A2(
					_elm_lang$core$Basics$compare,
					ratioDiff(nextImage),
					ratioDiff(bestImage));
				var _p0 = ratioDiffComparison;
				switch (_p0.ctor) {
					case 'LT':
						return nextImage;
					case 'GT':
						return bestImage;
					default:
						return bestCoversTarget ? (((_elm_lang$core$Native_Utils.cmp(nextImage.width, bestImage.width) < 0) && nextCoversTarget) ? nextImage : bestImage) : ((_elm_lang$core$Native_Utils.cmp(nextImage.width, bestImage.width) > 0) ? nextImage : bestImage);
				}
			});
		var _p1 = imageList;
		if (_p1.ctor === '[]') {
			...
			return function (_) {
				...
				A3(_elm_lang$core$List$foldl, selectBetterOfTwoImages, _p1._0, _p1._1));
		}
	});
var _user$project$Api_TicketMaster$dateDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (s) {
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Api_TicketMaster$imageRatioDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (str) {
		var intResults = A2(
			_elm_lang$core$List$map,
			_elm_lang$core$String$toInt,
			A2(_elm_lang$core$String$split, '_', str));
		var _p3 = intResults;
		if (((((_p3.ctor === '::') && (_p3._0.ctor === 'Ok')) && (_p3._1.ctor === '::')) && (_p3._1._0.ctor === 'Ok')) && (_p3._1._1.ctor === '[]')) {
			return _elm_lang$core$Json_Decode$succeed(
				{ctor: '_Tuple2', _0: _p3._0._0, _1: _p3._1._0._0});
		} else {
			return _elm_lang$core$Json_Decode$fail('Can\'t decode image width and height');
		}
	},
	_elm_lang$core$Json_Decode$string);
var _user$project$Api_TicketMaster$emptyEmbedded = {
	venues: {ctor: '[]'},
	attractions: {ctor: '[]'}
};
var _user$project$Api_TicketMaster$eventIdDecoder = _elm_lang$core$Json_Decode$string;
var _user$project$Api_TicketMaster$eventSearchTerm = function (event) {
	...
	var classification = function () {
		var _p5 = _elm_lang$core$List$head(event.classifications);
		if (_p5.ctor === 'Just') {
			var _p6 = _p5._0;
			return A2(
				_elm_lang$core$String$join,
	...
	var attractionName = function () {
		var _p7 = _elm_lang$core$List$head(event.embedded.attractions);
		if (_p7.ctor === 'Just') {
			return _p7._0.name;
		} else {
			return event.name;
	...
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			attractionName,
			A2(_elm_lang$core$Basics_ops['++'], '\" ', classification)));
};
var _user$project$Api_TicketMaster$dateFormat = function (d) {
	...
	var monthTwoDigitString = function () {
		var _p8 = _elm_lang$core$Date$month(d);
		switch (_p8.ctor) {
			case 'Jan':
				return '01';
			case 'Feb':
...
var _user$project$Api_TicketMaster$searchUrl = function (params) {
	var query = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'apikey', _1: _user$project$Secrets$ticketmaster},
		_1: params
	};
	var queryString = A2(
		_elm_lang$core$String$join,
		...
		A2(
			...
			query));
	var path = 'https://app.ticketmaster.com/discovery/v2/events.json';
	return A2(
		_elm_lang$core$Basics_ops['++'],
		path,
		A2(_elm_lang$core$Basics_ops['++'], '?', queryString));
};
var _user$project$Api_TicketMaster$apiParams = {
	ctor: '::',
	_0: 'apikey',
	_1: {
		ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: 'onsaleStartDateTime',
														_1: {
															ctor: '::',
															_0: 'onsaleEndDateTime',
															_1: {
																ctor: '::',
																_0: 'attractionId',
																_1: {
...
var _user$project$Api_TicketMaster$Response = F2(
	function (a, b) {
		return {events: a, page: b};
	});
var _user$project$Api_TicketMaster$Page = F4(
	function (a, b, c, d) {
		return {size: a, totalElements: b, totalPages: c, number: d};
	});
var _user$project$Api_TicketMaster$pageDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'size',
				_elm_lang$core$Json_Decode$int,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Page)))));
var _user$project$Api_TicketMaster$Event = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {name: a, type_: b, id: c, test: d, url: e, locale: f, images: g, sales: h, dates: i, classifications: j, promoter: k, info: l, pleaseNote: m, links: n, embedded: o};
														};
													};
												};
											};
...
var _user$project$Api_TicketMaster$Embedded = F2(
	function (a, b) {
		return {venues: a, attractions: b};
	});
var _user$project$Api_TicketMaster$Attraction = F4(
	function (a, b, c, d) {
		return {name: a, url: b, images: c, classifications: d};
	});
var _user$project$Api_TicketMaster$Venue = F3(
	function (a, b, c) {
		return {name: a, url: b, links: c};
	});
var _user$project$Api_TicketMaster$Links = F3(
	function (a, b, c) {
		return {self: a, attractions: b, venues: c};
	});
var _user$project$Api_TicketMaster$linksDecoder = A4(
	...
	A4(
		...
		A3(
			...
			'self',
			A2(_elm_lang$core$Json_Decode$field, 'href', _elm_lang$core$Json_Decode$string),
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Links))));
var _user$project$Api_TicketMaster$venueDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_links',
	_user$project$Api_TicketMaster$linksDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'url',
		_elm_lang$core$Json_Decode$string,
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Venue))));
var _user$project$Api_TicketMaster$Promoter = F3(
	function (a, b, c) {
		return {id: a, name: b, description: c};
	});
var _user$project$Api_TicketMaster$promoterDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'description',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Promoter))));
var _user$project$Api_TicketMaster$Classification = F4(
	function (a, b, c, d) {
		return {primary: a, segment: b, genre: c, subGenre: d};
	});
var _user$project$Api_TicketMaster$IdAndName = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$Api_TicketMaster$idAndNameDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'name',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$IdAndName)));
var _user$project$Api_TicketMaster$classificationDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'subGenre',
	_user$project$Api_TicketMaster$idAndNameDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'genre',
		_user$project$Api_TicketMaster$idAndNameDecoder,
		A3(
			...
			A3(
				...
				'primary',
				_elm_lang$core$Json_Decode$bool,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Classification)))));
var _user$project$Api_TicketMaster$EventDates = F3(
	function (a, b, c) {
		return {start: a, timezone: b, status: c};
	});
var _user$project$Api_TicketMaster$EventStartDate = F7(
	function (a, b, c, d, e, f, g) {
		return {localDate: a, localTime: b, dateTime: c, dateTBD: d, dateTBA: e, timeTBA: f, noSpecificTime: g};
	});
var _user$project$Api_TicketMaster$eventStartDateDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'noSpecificTime',
	_elm_lang$core$Json_Decode$bool,
	A3(
		...
		A3(
			...
			A3(
				...
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'dateTime',
					_user$project$Api_TicketMaster$dateDecoder,
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'localTime',
						_elm_lang$core$Json_Decode$string,
						A3(
							...
							'localDate',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$EventStartDate))))))));
var _user$project$Api_TicketMaster$Sales = F2(
	function (a, b) {
		return {$public: a, presales: b};
	});
var _user$project$Api_TicketMaster$PublicSale = F3(
	function (a, b, c) {
		return {startDateTime: a, startTBD: b, endDateTime: c};
	});
var _user$project$Api_TicketMaster$publicSaleDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'endDateTime',
	_elm_lang$core$Json_Decode$maybe(_user$project$Api_TicketMaster$dateDecoder),
	_elm_lang$core$Maybe$Nothing,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'startTBD',
		...
		A4(
			...
			_elm_lang$core$Json_Decode$maybe(_user$project$Api_TicketMaster$dateDecoder),
			_elm_lang$core$Maybe$Nothing,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$PublicSale))));
var _user$project$Api_TicketMaster$PreSale = F3(
	function (a, b, c) {
		return {startDateTime: a, endDateTime: b, name: c};
	});
var _user$project$Api_TicketMaster$preSaleDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'name',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			'startDateTime',
			_user$project$Api_TicketMaster$dateDecoder,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$PreSale))));
var _user$project$Api_TicketMaster$salesDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'presales',
	_elm_lang$core$Json_Decode$list(_user$project$Api_TicketMaster$preSaleDecoder),
	{ctor: '[]'},
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'public',
		_user$project$Api_TicketMaster$publicSaleDecoder,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Sales)));
var _user$project$Api_TicketMaster$Image = F5(
	function (a, b, c, d, e) {
		return {ratio: a, url: b, width: c, height: d, fallback: e};
	});
var _user$project$Api_TicketMaster$imageDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'fallback',
	_elm_lang$core$Json_Decode$bool,
	A3(
		...
		A3(
			...
			A3(
				...
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'ratio',
					_user$project$Api_TicketMaster$imageRatioDecoder,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Image))))));
var _user$project$Api_TicketMaster$attractionDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'classifications',
	_elm_lang$core$Json_Decode$list(_user$project$Api_TicketMaster$classificationDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'images',
		_elm_lang$core$Json_Decode$list(_user$project$Api_TicketMaster$imageDecoder),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'url',
			_elm_lang$core$Json_Decode$string,
			A3(
				...
				'name',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Attraction)))));
var _user$project$Api_TicketMaster$embeddedDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'attractions',
	_elm_lang$core$Json_Decode$list(_user$project$Api_TicketMaster$attractionDecoder),
	{ctor: '[]'},
	A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'venues',
		_elm_lang$core$Json_Decode$list(_user$project$Api_TicketMaster$venueDecoder),
		{ctor: '[]'},
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Embedded)));
var _user$project$Api_TicketMaster$Cancelled = {ctor: 'Cancelled'};
var _user$project$Api_TicketMaster$Postponed = {ctor: 'Postponed'};
var _user$project$Api_TicketMaster$Rescheduled = {ctor: 'Rescheduled'};
var _user$project$Api_TicketMaster$OffSale = {ctor: 'OffSale'};
var _user$project$Api_TicketMaster$OnSale = {ctor: 'OnSale'};
var _user$project$Api_TicketMaster$eventStatusDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (str) {
		var _p11 = str;
		switch (_p11) {
			case 'onsale':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Api_TicketMaster$OnSale);
			case 'offsale':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Api_TicketMaster$OffSale);
			case 'rescheduled':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Api_TicketMaster$Rescheduled);
			case 'postponed':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Api_TicketMaster$Postponed);
			case 'cancelled':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Api_TicketMaster$Cancelled);
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown event status: ', str));
		}
	},
	_elm_lang$core$Json_Decode$string);
var _user$project$Api_TicketMaster$eventDatesDecoder = A3(
	...
	_user$project$Api_TicketMaster$eventStatusDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'timezone',
		_elm_lang$core$Json_Decode$string,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'start',
			_user$project$Api_TicketMaster$eventStartDateDecoder,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$EventDates))));
var _user$project$Api_TicketMaster$eventDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'_embedded',
	_user$project$Api_TicketMaster$embeddedDecoder,
	_user$project$Api_TicketMaster$emptyEmbedded,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'_links',
		_user$project$Api_TicketMaster$linksDecoder,
		A4(
			...
			A4(
				...
				A4(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
					'promoter',
					_elm_lang$core$Json_Decode$maybe(_user$project$Api_TicketMaster$promoterDecoder),
					_elm_lang$core$Maybe$Nothing,
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'classifications',
						...
						A3(
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
							'dates',
							_user$project$Api_TicketMaster$eventDatesDecoder,
							A4(
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
								'sales',
								_elm_lang$core$Json_Decode$maybe(_user$project$Api_TicketMaster$salesDecoder),
								_elm_lang$core$Maybe$Nothing,
								A3(
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
									'images',
										...
										A3(
											...
											A3(
												...
												A3(
													_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
													'id',
													_user$project$Api_TicketMaster$eventIdDecoder,
													A3(
														_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
														'type',
														_elm_lang$core$Json_Decode$string,
														A3(
															...
															'name',
															_elm_lang$core$Json_Decode$string,
															_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Event))))))))))))))));
var _user$project$Api_TicketMaster$responseDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'page',
	_user$project$Api_TicketMaster$pageDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$requiredAt,
		{
			ctor: '::',
		...
		_elm_lang$core$Json_Decode$list(_user$project$Api_TicketMaster$eventDecoder),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_TicketMaster$Response)));

var _user$project$Api_YouTube$getFirstEmbedUrl = function (searchResult) {
	...
	return A2(
		...
		_elm_lang$core$String$append('https://www.youtube.com/embed/'),
		_elm_lang$core$List$head(
			A2(_elm_lang$core$List$filterMap, getVideoId, searchResult.items)));
};
var _user$project$Api_YouTube$searchUrl = function (searchTerm) {
	var query = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'part', _1: 'snippet'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'q', _1: searchTerm},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'key', _1: _user$project$Secrets$youtube},
				_1: {ctor: '[]'}
			}
		}
	};
	var queryString = A2(
		...
		A2(
			...
			query));
	var path = 'https://www.googleapis.com/youtube/v3/search';
	return A2(
		_elm_lang$core$Basics_ops['++'],
		path,
		A2(_elm_lang$core$Basics_ops['++'], '?', queryString));
};
var _user$project$Api_YouTube$SearchResult = F6(
	function (a, b, c, d, e, f) {
		return {kind: a, etag: b, nextPageToken: c, regionCode: d, pageInfo: e, items: f};
	});
var _user$project$Api_YouTube$SearchPageInfo = F2(
	function (a, b) {
		return {totalResults: a, resultsPerPage: b};
	});
var _user$project$Api_YouTube$decodeSearchPageInfo = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'resultsPerPage',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		'totalResults',
		_elm_lang$core$Json_Decode$int,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_YouTube$SearchPageInfo)));
var _user$project$Api_YouTube$SearchResultItem = F4(
	function (a, b, c, d) {
		return {kind: a, etag: b, id: c, snippet: d};
	});
var _user$project$Api_YouTube$SearchResultItemSnippetThumbnail = function (a) {
	return {url: a};
};
var _user$project$Api_YouTube$decodeSearchResultItemSnippetThumbnail = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'url',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_YouTube$SearchResultItemSnippetThumbnail));
var _user$project$Api_YouTube$SearchResultItemSnippetThumbnails = F3(
	function (a, b, c) {
		return {$default: a, medium: b, high: c};
	});
var _user$project$Api_YouTube$decodeSearchResultItemSnippetThumbnails = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'high',
	_user$project$Api_YouTube$decodeSearchResultItemSnippetThumbnail,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'medium',
		_user$project$Api_YouTube$decodeSearchResultItemSnippetThumbnail,
		A3(
			...
			'default',
			_user$project$Api_YouTube$decodeSearchResultItemSnippetThumbnail,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_YouTube$SearchResultItemSnippetThumbnails))));
var _user$project$Api_YouTube$SearchResultItemSnippet = F7(
	function (a, b, c, d, e, f, g) {
		return {publishedAt: a, channelId: b, title: c, description: d, thumbnails: e, channelTitle: f, liveBroadcastContent: g};
	});
var _user$project$Api_YouTube$decodeSearchResultItemSnippet = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	...
	A3(
		...
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'thumbnails',
			_user$project$Api_YouTube$decodeSearchResultItemSnippetThumbnails,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'description',
				_elm_lang$core$Json_Decode$string,
				A3(
					...
					A3(
						...
						A3(
							...
							'publishedAt',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_YouTube$SearchResultItemSnippet))))))));
var _user$project$Api_YouTube$Playlist = function (a) {
	return {ctor: 'Playlist', _0: a};
};
var _user$project$Api_YouTube$Video = function (a) {
	return {ctor: 'Video', _0: a};
};
var _user$project$Api_YouTube$Channel = function (a) {
	return {ctor: 'Channel', _0: a};
};
var _user$project$Api_YouTube$idKind = function (kind) {
	var _p3 = kind;
	switch (_p3) {
		case 'youtube#channel':
			return A2(
				_elm_lang$core$Json_Decode$map,
				_user$project$Api_YouTube$Channel,
				A2(_elm_lang$core$Json_Decode$field, 'channelId', _elm_lang$core$Json_Decode$string));
		case 'youtube#video':
			return A2(
				_elm_lang$core$Json_Decode$map,
				_user$project$Api_YouTube$Video,
				A2(_elm_lang$core$Json_Decode$field, 'videoId', _elm_lang$core$Json_Decode$string));
		case 'youtube#playlist':
			return A2(
				_elm_lang$core$Json_Decode$map,
				_user$project$Api_YouTube$Playlist,
				A2(_elm_lang$core$Json_Decode$field, 'playlistId', _elm_lang$core$Json_Decode$string));
		default:
			return _elm_lang$core$Json_Decode$fail('Unknown kind of YouTube object');
	}
};
var _user$project$Api_YouTube$decodeSearchResultItemId = A2(
	_elm_lang$core$Json_Decode$andThen,
	_user$project$Api_YouTube$idKind,
	A2(_elm_lang$core$Json_Decode$field, 'kind', _elm_lang$core$Json_Decode$string));
var _user$project$Api_YouTube$decodeSearchResultItem = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'snippet',
	_user$project$Api_YouTube$decodeSearchResultItemSnippet,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'id',
		_user$project$Api_YouTube$decodeSearchResultItemId,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'etag',
			_elm_lang$core$Json_Decode$string,
			A3(
				...
				'kind',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_YouTube$SearchResultItem)))));
var _user$project$Api_YouTube$decodeSearchResult = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'items',
	_elm_lang$core$Json_Decode$list(_user$project$Api_YouTube$decodeSearchResultItem),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'pageInfo',
		_user$project$Api_YouTube$decodeSearchPageInfo,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'regionCode',
			_elm_lang$core$Json_Decode$string,
			A4(
				...
				A3(
					...
					A3(
						...
						'kind',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Api_YouTube$SearchResult)))))));

var _user$project$Types$Model = F4(
	function (a, b, c, d) {
		return {events: a, videos: b, startDate: c, endDate: d};
	});
var _user$project$Types$ChangeEndDate = function (a) {
	return {ctor: 'ChangeEndDate', _0: a};
};
var _user$project$Types$ChangeStartDate = function (a) {
	return {ctor: 'ChangeStartDate', _0: a};
};
var _user$project$Types$YouTubeResult = F2(
	function (a, b) {
		return {ctor: 'YouTubeResult', _0: a, _1: b};
	});
var _user$project$Types$SearchDone = function (a) {
	return {ctor: 'SearchDone', _0: a};
};
...
var _user$project$View$eventVideoUrl = function (webData) {
	var firstEmbedUrl = function () {
		var _p0 = webData;
		if (_p0.ctor === 'Success') {
			return _user$project$Api_YouTube$getFirstEmbedUrl(_p0._0);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	}();
	return A2(_elm_lang$core$Maybe$withDefault, '', firstEmbedUrl);
};
var _user$project$View$eventImageUrl = function (event) {
	var height = 115;
	var ratio = {ctor: '_Tuple2', _0: 16, _1: 9};
	return A3(_user$project$Api_TicketMaster$selectImageUrl, ratio, height, event.images);
};
var _user$project$View$venueLink = function (venue) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(venue.url),
			_1: {
				ctor: '::',
...
var _user$project$View$eventDetails = function (event) {
	return {
		ctor: '::',
		_0: A2(
			...
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], ' ', event.dates.start.localTime))),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				A2(_elm_lang$core$List$map, _user$project$View$venueLink, event.embedded.venues)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
...
var _user$project$View$event = F2(
	function (videos, ev) {
		var searchTerm = _user$project$Api_TicketMaster$eventSearchTerm(ev);
		var videoUrl = function () {
			var _p1 = A2(_elm_lang$core$Dict$get, searchTerm, videos);
			if (_p1.ctor === 'Just') {
				return _user$project$View$eventVideoUrl(_p1._0);
			} else {
				return '';
			}
		}();
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('row event'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(ev.name),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('row well'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$img,
										{
											...
											_0: _elm_lang$html$Html_Attributes$src(
												_user$project$View$eventImageUrl(ev)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$width(205),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$height(105),
													_1: {ctor: '[]'}
												}
											}
										},
							...
							_1: {
								...
								_0: A2(
									...
									_user$project$View$eventDetails(ev)),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$src(videoUrl),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$width(205),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$height(115),
															_1: {
																ctor: '::',
...
var _user$project$View$eventList = function (model) {
	var _p2 = model.events;
	switch (_p2.ctor) {
		case 'NotAsked':
			return _elm_lang$html$Html$text('Request not sent yet');
		case 'Loading':
		...
		default:
			return A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$View$event(model.videos),
					_p2._0.events));
	}
};
var _user$project$View$inputForm = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$value(
							_user$project$Api_TicketMaster$dateFormat(model.startDate)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$ChangeStartDate),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('End Date'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(
								_user$project$Api_TicketMaster$dateFormat(model.endDate)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$ChangeEndDate),
								_1: {ctor: '[]'}
							}
						}
					},
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Brian\'s Event Guide'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$View$inputForm(model),
				_1: {
					ctor: '::',
					_0: _user$project$View$eventList(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$fetchVideos = function (searchTerm) {
	return A2(
		_elm_lang$http$Http$send,
		function (x) {
			return A2(_user$project$Types$YouTubeResult, searchTerm, x);
		},
		A2(
			_elm_lang$http$Http$get,
			_user$project$Api_YouTube$searchUrl(searchTerm),
			_user$project$Api_YouTube$decodeSearchResult));
};
var _user$project$Main$generateVideoQueries = F2(
	function (response, videoDict) {
		var addLoadingItemToDict = F2(
			function (searchTerm, dict) {
				return A3(_elm_lang$core$Dict$insert, searchTerm, _user$project$Types$Loading, dict);
			});
		var newSearchTerms = A2(
			_elm_lang$core$List$filter,
			function (name) {
				return !A2(_elm_lang$core$Dict$member, name, videoDict);
			},
			A2(_elm_lang$core$List$map, _user$project$Api_TicketMaster$eventSearchTerm, response.events));
		var updatedVideoDict = A3(_elm_lang$core$List$foldl, addLoadingItemToDict, videoDict, newSearchTerms);
		var command = _elm_lang$core$Platform_Cmd$batch(
			A2(_elm_lang$core$List$map, _user$project$Main$fetchVideos, newSearchTerms));
		return {ctor: '_Tuple2', _0: updatedVideoDict, _1: command};
	});
var _user$project$Main$fetchEvents = F2(
	function (start, end) {
		var url = _user$project$Api_TicketMaster$searchUrl(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'city', _1: 'london'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'countryCode', _1: 'gb'},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'size',
							_1: _elm_lang$core$Basics$toString(10)
						},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'classificationName', _1: 'music'},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'startDateTime',
									_1: _user$project$Api_TicketMaster$dateFormat(start)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'endDateTime',
										_1: _user$project$Api_TicketMaster$dateFormat(end)
									},
									_1: {ctor: '[]'}
								}
							}
		...
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Types$SearchDone,
			A2(_elm_lang$http$Http$get, url, _user$project$Api_TicketMaster$responseDecoder));
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Init':
				var nowNearestSecond = 1000 * _elm_lang$core$Basics$round(_p0._0 / 1000);
				var start = _elm_lang$core$Date$fromTime(
					_elm_lang$core$Basics$toFloat(nowNearestSecond));
				var days = 14;
				var end = _elm_lang$core$Date$fromTime(
					_elm_lang$core$Basics$toFloat(
						nowNearestSecond + ((days * 24) * _elm_lang$core$Basics$round(_elm_lang$core$Time$hour))));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{events: _user$project$Types$Loading, startDate: start, endDate: end}),
					_1: A2(_user$project$Main$fetchEvents, start, end)
				};
			case 'SearchDone':
				if (_p0._0.ctor === 'Err') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								events: _user$project$Types$Failure(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p2 = _p0._0._0;
					var _p1 = A2(_user$project$Main$generateVideoQueries, _p2, model.videos);
					var updatedVideoDict = _p1._0;
					var fetchVideosCmd = _p1._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								events: _user$project$Types$Success(_p2),
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								videos: A3(
									_elm_lang$core$Dict$insert,
									_p0._0,
									_user$project$Types$Failure(_p0._1._0),
									model.videos)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								videos: A3(
									_elm_lang$core$Dict$insert,
									_p0._0,
									_user$project$Types$Success(_p0._1._0),
									model.videos)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'ChangeStartDate':
				var _p3 = _elm_lang$core$Date$fromString(_p0._0);
				if (_p3.ctor === 'Ok') {
					var _p4 = _p3._0;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{startDate: _p4}),
						_1: A2(_user$project$Main$fetchEvents, _p4, model.endDate)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			default:
				var _p5 = _elm_lang$core$Date$fromString(_p0._0);
				if (_p5.ctor === 'Ok') {
					var _p6 = _p5._0;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{endDate: _p6}),
						_1: A2(_user$project$Main$fetchEvents, model.startDate, _p6)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		events: _user$project$Types$NotAsked,
		videos: _elm_lang$core$Dict$empty,
		startDate: _elm_lang$core$Date$fromTime(0),
		endDate: _elm_lang$core$Date$fromTime(0)
	},
	_1: A2(_elm_lang$core$Task$perform, _user$project$Types$Init, _elm_lang$core$Time$now)
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Api.YouTube.SearchResultItemId":{"args":[],"tags":{"Channel":["String"],"Video":["String"],"Playlist":["String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Types.Msg":{"args":[],"tags":{"YouTubeResult":["String","Result.Result Http.Error Api.YouTube.SearchResult"],"ChangeStartDate":["String"],"Init":["Time.Time"],"ChangeEndDate":["String"],"SearchDone":["Result.Result Http.Error Api.TicketMaster.Response"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Api.TicketMaster.EventStatus":{"args":[],"tags":{"OffSale":[],"OnSale":[],"Postponed":[],"Rescheduled":[],"Cancelled":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Api.TicketMaster.PreSale":{"args":[],"type":"{ startDateTime : Date.Date, endDateTime : Date.Date, name : String }"},"Api.TicketMaster.Promoter":{"args":[],"type":"{ id : String, name : String, description : String }"},"Api.YouTube.SearchResult":{"args":[],"type":"{ kind : String , etag : String , nextPageToken : String , regionCode : String , pageInfo : Api.YouTube.SearchPageInfo , items : List Api.YouTube.SearchResultItem }"},"Api.YouTube.SearchResultItemSnippet":{"args":[],"type":"{ publishedAt : String , channelId : String , title : String , description : String , thumbnails : Api.YouTube.SearchResultItemSnippetThumbnails , channelTitle : String , liveBroadcastContent : String }"},"Api.TicketMaster.Attraction":{"args":[],"type":"{ name : String , url : String , images : List Api.TicketMaster.Image , classifications : List Api.TicketMaster.Classification }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Api.TicketMaster.Sales":{"args":[],"type":"{ public : Api.TicketMaster.PublicSale , presales : List Api.TicketMaster.PreSale }"},"Api.TicketMaster.EventStartDate":{"args":[],"type":"{ localDate : String , localTime : String , dateTime : Date.Date , dateTBD : Bool , dateTBA : Bool , timeTBA : Bool , noSpecificTime : Bool }"},"Api.TicketMaster.Links":{"args":[],"type":"{ self : String, attractions : List String, venues : List String }"},"Api.TicketMaster.IdAndName":{"args":[],"type":"{ id : String, name : String }"},"Api.TicketMaster.EventId":{"args":[],"type":"String"},"Api.TicketMaster.Event":{"args":[],"type":"{ name : String , type_ : String , id : Api.TicketMaster.EventId , test : Bool , url : String , locale : String , images : List Api.TicketMaster.Image , sales : Maybe.Maybe Api.TicketMaster.Sales , dates : Api.TicketMaster.EventDates , classifications : List Api.TicketMaster.Classification , promoter : Maybe.Maybe Api.TicketMaster.Promoter , info : Maybe.Maybe String , pleaseNote : Maybe.Maybe String , links : Api.TicketMaster.Links , embedded : Api.TicketMaster.Embedded }"},"Api.TicketMaster.Image":{"args":[],"type":"{ ratio : ( Int, Int ) , url : String , width : Int , height : Int , fallback : Bool }"},"Api.YouTube.SearchResultItem":{"args":[],"type":"{ kind : String , etag : String , id : Api.YouTube.SearchResultItemId , snippet : Api.YouTube.SearchResultItemSnippet }"},"Api.TicketMaster.PublicSale":{"args":[],"type":"{ startDateTime : Maybe.Maybe Date.Date , startTBD : Bool , endDateTime : Maybe.Maybe Date.Date }"},"Api.TicketMaster.Venue":{"args":[],"type":"{ name : String, url : String, links : Api.TicketMaster.Links }"},"Api.YouTube.SearchResultItemSnippetThumbnails":{"args":[],"type":"{ default : Api.YouTube.SearchResultItemSnippetThumbnail , medium : Api.YouTube.SearchResultItemSnippetThumbnail , high : Api.YouTube.SearchResultItemSnippetThumbnail }"},"Api.TicketMaster.EventDates":{"args":[],"type":"{ start : Api.TicketMaster.EventStartDate , timezone : String , status : Api.TicketMaster.EventStatus }"},"Api.TicketMaster.Response":{"args":[],"type":"{ events : List Api.TicketMaster.Event , page : Api.TicketMaster.Page }"},"Api.TicketMaster.Page":{"args":[],"type":"{ size : Int, totalElements : Int, totalPages : Int, number : Int }"},"Api.TicketMaster.Embedded":{"args":[],"type":"{ venues : List Api.TicketMaster.Venue , attractions : List Api.TicketMaster.Attraction }"},"Api.YouTube.SearchResultItemSnippetThumbnail":{"args":[],"type":"{ url : String }"},"Api.YouTube.SearchPageInfo":{"args":[],"type":"{ totalResults : Int, resultsPerPage : Int }"},"Api.TicketMaster.Classification":{"args":[],"type":"{ primary : Bool , segment : Api.TicketMaster.IdAndName , genre : Api.TicketMaster.IdAndName , subGenre : Api.TicketMaster.IdAndName }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
